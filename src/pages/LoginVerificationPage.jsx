  ...
  return (
    <>
        ...
        <div className='buttonset'>
          <input type='number' maxLength={1} className='VerifyInput' id='1' placeholder='' />
          <input type='number' maxLength={1} className='VerifyInput' id='2' placeholder='' />
          <input type='number' maxLength={1} className='VerifyInput' id='3' placeholder='' />
          <input type='number' maxLength={1} className='VerifyInput' id='4' placeholder='' />
        </div>
